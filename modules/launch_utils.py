...
{"Alternatively, use a binary release of WebUI: https://github.com/sOoN92/stable-diffusion-webui/releases/tag/v1.0.0-pre" if is_windows else ""}
...
def version_check(commit):
    try:
        import requests
        commits = requests.get('https://api.github.com/repos/sOoN92/stable-diffusion-webui/branches/master').json()
...
def prepare_environment():
    ...
    assets_repo = os.environ.get('ASSETS_REPO', "https://github.com/sOoN92/stable-diffusion-webui-assets.git")
